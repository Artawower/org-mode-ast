...
#+END_SRC`;
    ...
    expect(prettyTreePrint(result)).toEqual(`root [0-42]
  srcBlock [0-42]
    blockHeader [0-11]
...
#+END_SRC`;
    ...
    removeInformationAboutRelatives(result);
    console.log(prettyTreePrint(result));
    expect(prettyTreePrint(result)).toEqual(`root [0-21]
  srcBlock [0-21]
    blockHeader [0-11]
      keyword [0-11] ("#+BEGIN_SRC")
    newLine [11-12]
...
#+END_SRC`;
    ...
    removeInformationAboutRelatives(result);
    console.log(prettyTreePrint(result));
    expect(prettyTreePrint(result)).toEqual(`root [0-44]
  srcBlock [0-44]
      :language python:
      :tangle test.py:
    blockHeader [0-34]
...
Some text without end src`;
    ...
    removeInformationAboutRelatives(result);
    console.log(prettyTreePrint(result));
    expect(prettyTreePrint(result)).toEqual(`root [0-37]
  keyword [0-11] ("#+BEGIN_SRC")
  newLine [11-12]
